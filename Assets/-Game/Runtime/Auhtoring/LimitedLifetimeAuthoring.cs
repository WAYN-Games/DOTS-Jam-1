...
class LimitedLifetimeAuthoring : MonoBehaviour
{
    public float Duration;
}

class LimitedLifetimeAuthoringBaker : Baker<LimitedLifetimeAuthoring>
{
    public float Duration;

    public override void Bake(LimitedLifetimeAuthoring authoring)
    {
